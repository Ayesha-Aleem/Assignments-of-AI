...
print("_______")
Start3 = datetime.now()
print("UCS",UCS(Graph(),"Brest","Limoges"))
End3 = datetime.now()
print("___________")
Start4 = datetime.now()
print("A star:", Astar(Graph(), "Brest","Limoges"))
End4 = datetime.now()
a=len(DFS(Graph(),"Brest"))
b=len(BFS(Graph(),"Brest"))
c=len(GS(Graph(),"Brest","Limoges"))
d=len(UCS(Graph(),"Brest","Limoges"))
e=len(Astar(Graph(), "Brest","Limoges"))
